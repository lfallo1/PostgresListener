 ...
 *
 */
public class MyGeneInactiveAccountListener extends Thread {
	...
	public MyGeneInactiveAccountListener(Connection conn, String notifierKey, AccountRowMapper mapper, 
			...
			try {
				...
				if (notifications != null) {
					for (int i=0; i<notifications.length; i++) {
						...
						EmailConfig emailConfig = this.emailConfigFactory.generateWithBasicAccountInfo(account, "velocity/pendingDeletion.vm", "Account will be deleted in 7 days");
				...
				System.out.println("MyGeneInactiveAccountListener stopped!");
